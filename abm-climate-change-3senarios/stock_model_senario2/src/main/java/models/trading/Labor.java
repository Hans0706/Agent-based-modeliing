    ...
    public static Action<Labor> updateLP() {
        return action(
                labor -> {
                    ...
                    if (labor.getGlobals().mode==1){
                        if (temp < 0) {

                            labor.aveLp1 = labor.aveLp1 * 1.13;
                            labor.aveLp2 = labor.aveLp2 * 1.25;
                        } else {
                            labor.aveLp1 = labor.aveLp1 * 0.95;
                            labor.aveLp2 = labor.aveLp2 * 0.83;
                        }
                    }
                    else if(labor.getGlobals().mode==2){
                        if (temp < 0) {
                            if(labor.getGlobals().year_num>30){
                                labor.aveLp1 = labor.aveLp1 * 1.05;
                            ...
                            if(labor.getGlobals().year_num<30){
                                labor.aveLp1 = labor.aveLp1 * 0.98;
                        ...
                        if (temp < 0) {
                            ...
                            labor.aveLp1 = labor.aveLp1 * 1.02;
                            labor.aveLp2 = labor.aveLp1 * 1.25;
                        } else {
                            labor.aveLp1 = labor.aveLp1 * 0.95;
                            labor.aveLp2 = labor.aveLp1 * 0.83;
