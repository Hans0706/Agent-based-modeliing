...
@ModelSettings(macroStep = 40,timeUnit="YEARS",start = "2000-01-01T00:00:00Z")
...
//    }
    ...
    public void init() {
        ...
        createDoubleAccumulator("energyPrice", "Energy Price");
        ...
        getDoubleAccumulator("emission").add(1200);
        getDoubleAccumulator("energyPrice").add(50);
...
//        Group<Market> marketGroup = generateGroup(Market.class, 1, market -> market.nbTraders = nbTraders);
        Group<CaFirm> caFirmGroup = generateGroup(CaFirm.class, 20);
        Group<CoFirm> coFirmGroup = generateGroup(CoFirm.class, 10);
...
//       CaFirm.conductBehavior,CoFirm.conductBehavior,Labor.processInformation());
        ...
        run(Split.create(
                ...
                Country.updateTax);
        run(Split.create(
                EnproFirm.sendEmissions,
                CoFirm.sendEmission,
                CaFirm.sendEmission,
                EntechFirm.sendEmission),
                Country.receiveEmissions);
